...
class DataHandler(xml.sax.handler.ContentHandler):
    ...
    def write_index(self, startTag, id):
        ...
        self.writer.add_document(key=id, type=startTag, author=self.tags["author"], title=self.tags["title"], year=self.tags["year"],
